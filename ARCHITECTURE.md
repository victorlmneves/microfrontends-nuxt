...
- **@module-federation/runtime 2.0.1**: Runtime API for loading remotes (host package.json only)
- **@module-federation/vite 1.10.0**: Vite plugin for building remotes (root package.json, shared via workspace)
- **vite-plugin-top-level-await 1.6.0**: Enables top-level await in remotes (root package.json, shared via workspace)
- **Turborepo**: Monorepo orchestration
- **pnpm 8.15.0**: Package manager with workspace hoisting
